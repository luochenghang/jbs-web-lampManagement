...
$(function(){
    ...
    $("#addProduct").click(function(){
        ...
        var filesDetailPath = $("#filesDetailPath").val();

        if (filesDetailPath == "") {
            layer.alert("请上传商品详情图！",{
                    title: '提示框',               
                    icon:0,                             
              }); 
              return false; 
          ...
          formData.append('filesDetailPath', filesDetailPath);
          $.ajax({
                url: addGoodsuploadUrl,
                type: 'post',
                data: formData,
                async: false,
                        cache: false,
        ...
        //     'sellPrice':sellPrice,
        //     'coverImg':coverImg,
        //     'goodInfo':'', //这里应该是一个集合或者字符串
        //     },
        //     success: function (res) {
        //         console.log(res);
        //         if(res.code == 1000){
        //             layer.msg('添加成功',2, 9,function(){
        //             window.location.href="goods_type.html";
        //         });
        //         }else{
...
jQuery(function() {
    ...
    uploader.on('uploadSuccess', function(file,res){
        ...
        $upload.hide();
        //在原有的文本框添加记录
        if ($("#filesDetailPath").val() == "") {
            $("#filesDetailPath").val(res.data);
        }else{
            $("#filesDetailPath").val($("#filesDetailPath").val() + "," + res.data);
        }
        
        // $("#coverImg").val("https://luochenghang.com/source/"+res.data);
    });
